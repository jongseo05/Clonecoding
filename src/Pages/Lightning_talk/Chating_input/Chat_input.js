...
import Image_upload_modal from '../Modal/Image_upload_modal/Image_upload_modal';
...
function ChatInput({ onSendMessage, chatId }) {
    ...
    // 컴포넌트 마운트 시 채팅 ID와 인증 상태 확인
    useEffect(() => {
        console.log("Chat_input 컴포넌트 마운트");
